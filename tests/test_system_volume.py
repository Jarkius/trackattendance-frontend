#!/usr/bin/env python3
"""Unit tests for system_volume.set_system_volume_max().
...
class TestSetSystemVolumeMax(unittest.TestCase):
    ...
    def test_sets_volume_to_max_and_unmutes(self):
    ...
    def test_unmutes_unconditionally_even_when_getmute_reports_unmuted(self):
        ...
        with patch.dict(sys.modules, {"pycaw": MagicMock(), "pycaw.pycaw": mock_pycaw_module}):
            system_volume.set_system_volume_max()
